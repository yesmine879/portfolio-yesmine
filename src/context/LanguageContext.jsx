...
const translations = {
  ...
  fr: {
    ...
    exploreClub: 'Découvrir le club', viewGallery: 'Voir la galerie', openClubGallery: 'Ouvrir la galerie du club', closeClubGallery: 'Fermer la galerie du club', clubDialogLabel: 'Détails du club et galerie', clubLogo: 'logo', clubEventStory: 'Histoire de l’événement', galleryEditHint: 'Remplacez les emplacements de cette galerie par vos photos ou extraits vidéo d’événements.', nextMedia: 'Média suivant',
    clubsData: {
